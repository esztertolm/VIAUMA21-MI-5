    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary to-purple-600 p-5">
      <div className="bg-card p-10 rounded-lg shadow-2xl w-full max-w-[400px]">
        ...
        <div className="space-y-2">
          <Button variant="outline" className="w-full" onClick={() => alert('Google bejelentkezés hamarosan elérhető!')}>
          ...
          <Button variant="outline" className="w-full" onClick={() => alert('GitHub bejelentkezés hamarosan elérhető!')}>
